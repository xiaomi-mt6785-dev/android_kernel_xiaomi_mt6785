...
#define LIGHTSECONDARY 0x92
#define LIGHTSECONDARY_IOCTL_INIT _IOW(LIGHTSECONDARY, 0x01, int)
#define LIGHTSECONDARY_IOCTL_READ_SENSORDATA _IOR(LIGHTSECONDARY, 0x02, struct SENSOR_DATA)
#define LIGHTSECONDARY_IOCTL_GET_CALI  _IOR(LIGHTSECONDARY, 0x03, struct SENSOR_DATA)
#define LIGHTSECONDARY_IOCTL_ENABLE_CALI _IO(LIGHTSECONDARY, 0x04)
#ifdef CONFIG_COMPAT
#define COMPAT_LIGHTSECONDARY_IOCTL_INIT _IOW(LIGHTSECONDARY, 0x01, compat_int_t)
#define COMPAT_LIGHTSECONDARY_IOCTL_READ_SENSORDATA _IOR(LIGHTSECONDARY, 0x02, struct SENSOR_DATA)
#define COMPAT_LIGHTSECONDARY_IOCTL_GET_CALI _IOR(LIGHTSECONDARY, 0x03, struct SENSOR_DATA)
#define COMPAT_LIGHTSECONDARY_IOCTL_ENABLE_CALI _IO(LIGHTSECONDARY, 0x04)
#endif
